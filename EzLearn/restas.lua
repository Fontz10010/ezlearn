...
function Problema(  )
	...
	print(resCorrecta.text)

	local posicion = math.random(1,4)
	if posicion == 1 then
		respuesta1.text = respuestaCorrecta
		respuesta2.text =  math.random(1,20)
		respuesta3.text =  math.random(1,20)
		respuesta4.text =  math.random(1,20)
	elseif posicion == 2 then
		respuesta2.text = respuestaCorrecta 
		respuesta1.text =  math.random(1,20)
		respuesta3.text =  math.random(1,20)
		respuesta4.text =  math.random(1,20)
...
local scoreanterior
			local path = system.pathForFile( "scorerest.txt", system.DocumentsDirectory )
